...
seeFetch.config('order/search/phone', {
  method: ['post'],
  stringify: [!0],
  requestKeys: [requestKeys, requestKeys],
  url: [
    '/order/searchOrderByPhone',
    '/src/order_manage/search_order/mock/phone_server.json',
    '/src/order_manage/search_order/mock/phone.json',
  ],
