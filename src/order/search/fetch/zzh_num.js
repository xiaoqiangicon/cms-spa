...
seeFetch.config('order/search/zzhNum', {
  method: ['post'],
  stringify: [!0],
  requestKeys: [requestKeys, requestKeys],
  url: [
    '/order/searchOrderByZizaihomeNumber',
    '/src/order_manage/search_order/mock/zzh_num_server.json',
    '/src/order_manage/search_order/mock/zzh_num.json',
  ],
